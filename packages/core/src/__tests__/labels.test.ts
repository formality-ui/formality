...
describe("Labels Module", () => {
  ...
  describe("resolveLabel", () => {
    ...
    it("should use field config props.label", () => {
      expect(resolveLabel("field", { props: { label: "Props Label" } })).toBe(
        "Props Label",
      );
    });

    it("should use evaluated selectProps.label", () => {
      expect(resolveLabel("field", {}, { label: "Select Props Label" })).toBe(
        "Select Props Label",
      );
    });
  ...
  describe("isAutoGeneratedLabel", () => {
    it("should detect auto-generated labels", () => {
      expect(isAutoGeneratedLabel("clientContact", "Client Contact")).toBe(
        true,
      );
  ...
  describe("Field Ordering", () => {
    ...
    describe("sortFieldsByOrder", () => {
      ...
      it("should handle negative orders", () => {
        ...
        expect(
          sortFieldsByOrder(["third", "first", "second"], configs),
