...
function assertNotNullOrUndefined<T>(value: T | null | undefined, message?: string): T {
...
function calculateTotal(price: number | null | undefined, quantity: number | null | undefined): number {
...
```typescript
function publicApiCalculate(price: number | null, quantity: number | null): number {
...
```typescript
function processDataset(items: Array<{ value: number | null | undefined }>): number[] {
    return items
        .map(item => item.value)
